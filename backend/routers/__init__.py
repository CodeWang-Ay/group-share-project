...
from .shared_resources_router import router as shared_resources_router
from .health_router import router as health_router
from .page_router import router as page_router
from .meeting_schedule_router import router as meeting_schedule_router
from .message_system_router import router as message_system_router
from .research_tasks_router import router as research_tasks_router
from .member_management_router import router as member_management_router
