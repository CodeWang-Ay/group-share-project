...
@router.get("/members")
async def get_members(request: Request, current_user=Depends(get_current_user), service: MemberService = Depends()):
    """获取成员列表"""
...
async def get_members_stats(request: Request, current_user=Depends(get_current_user), service: MemberService = Depends()):
    """获取成员统计"""
...
async def update_member_status(member_id: int, request: Request, current_user=Depends(get_current_user), service: MemberService = Depends()):
    """更新成员状态"""
...
async def update_member_info(member_id: int, request: Request, current_user=Depends(get_current_user), service: MemberService = Depends()):
    """更新成员信息"""
    data = await request.json()
...
@router.post("/members")
async def create_member(request: Request, current_user=Depends(get_current_user), service: MemberService = Depends()):
    """添加成员"""
    data = await request.json()
...
async def delete_member(member_id: int, request: Request, current_user=Depends(get_current_user), service: MemberService = Depends()):
    """删除成员"""
...
async def reset_member_password(member_id: int, request: Request, current_user=Depends(get_current_user), service: MemberService = Depends()):
    """重置密码"""
    data = await request.json()
...
async def batch_update_user_role(request: Request, current_user=Depends(get_current_user), service: MemberService = Depends()):
    """批量修改角色"""
    data = await request.json()
...
async def batch_update_user_status(request: Request, current_user=Depends(get_current_user), service: MemberService = Depends()):
    """批量修改状态"""
    data = await request.json()
...
async def batch_delete_users(request: Request, current_user=Depends(get_current_user), service: MemberService = Depends()):
    """批量删除成员"""
    data = await request.json()
